...
class FluentIcons {
  ...
  static Future<void> initialize() async {
    ...
    _isLoading = true;
    try {
      final String jsonString = await rootBundle.loadString('assets/font/FluentSystemIcons-Regular.json');
      ...
      jsonData.forEach((key, value) {
        if (value is int) {
          ...
          String cleanName = key
              .replaceFirst('ic_fluent_', '')
              .replaceFirst('_regular', '');
          if (cleanName != key) {
      ...
      _isLoaded = true;
      print('✅ FluentIcons 已加载 ${_iconMap!.length} 个图标');
    } catch (e) {
      print('❌ FluentIcons 加载失败: $e');
    } finally {
      _isLoading = false;
    }
  }
  ...
  static IconData getIcon(String name, {int? fallbackCode}) {
    if (_iconMap == null) {
      print('⚠️ FluentIcons 未初始化，请先调用 FluentIcons.initialize()');
      return IconData(
  ...
  static IconData get arrowMinimize20 => getIcon('ic_fluent_full_screen_minimize_20_regular');
  static IconData get arrowMinimize24 => getIcon('ic_fluent_full_screen_minimize_24_regular');
  ...
  static IconData get arrow_maximize_vertical_20 => getIcon('arrow_maximize_vertical_20');
  static IconData get arrow_maximize_vertical_24 => getIcon('arrow_maximize_vertical_24');
  ...
  static IconData get full_screen_maximize_20 => getIcon('full_screen_maximize_20');
  static IconData get full_screen_maximize_24 => getIcon('full_screen_maximize_24');
